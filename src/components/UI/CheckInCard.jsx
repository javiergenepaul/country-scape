...
function CheckInCard() {
	...
	const icon = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" fill="none"><path fill="#fff" fill-rule="evenodd" d="M6.2 2.1a3.6 3.6 0 1 0 0 7.2 3.6 3.6 0 0 0 0-7.2ZM.8 5.7a5.4 5.4 0 1 1 9.8 3.129l4.336 4.335a.9.9 0 0 1-1.272 1.273l-4.335-4.335A5.4 5.4 0 0 1 .8 5.7Z" clip-rule="evenodd"/></svg>;
	return (
